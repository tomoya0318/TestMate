      ...
      <Container maxW="container.xl">
        <VStack>
          <Box bg="#0DCEDA" p="10" color="white" width={scrennWidth}>
            ...
            >
              テスターに参加していただける方には、以下の3つをお願いします
            </h1>
          </Box>
          <Box
            p={10}
          ...
          >
            <OrderedList spacing={6}>
              <ListItem>
                <Link href="#registar">Google Groupsに登録する</Link>
              </ListItem>
              <ListItem>
                <Link href="#install">アプリをインストールする</Link>
              </ListItem>
              <ListItem>
                <Link href="#launch">アプリを起動する</Link>
              </ListItem>
              <ListItem>
                <Link href="#comment">コメントする</Link>
              </ListItem>
            </OrderedList>
          </Box>
        </VStack>
      ...
      <Container id="install">
        <VStack>
          ...
          <Alert width={scrennWidth} status="warning">
            ...
            <AlertDescription>
              もし「リクエストされた URL
              は、このサーバー上に見つかりませんでした。」と表示される場合、Google
              Groupsに登録できていないかもしれません。もう一度試してみてください。
            </AlertDescription>
          </Alert>
      ...
      <Container id="launch">
        <VStack>
          ...
          <Alert width={scrennWidth} status="error">
            ...
            <AlertDescription>
              一度インストールしたら、特別な理由がない限り、アプリを削除しないようにお願いします。
              （アンインストールしてしまうとテスターから外れてしまうため）
            </AlertDescription>
          </Alert>
        </VStack>
      </Container>
